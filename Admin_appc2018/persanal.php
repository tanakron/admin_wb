                            ...
                            <div class="user-btm-box">
                                ...
                                <hr>
                                 ...
                                 <hr>
                                   ...
                                   <div class="row text-center m-t-12">
                                    <div class="col-md-6 b-r"><strong>Hospital</strong>
                                        <p><?php echo $row_cust['hospital']; ?></p>
                                    </div>
                                    <div class="col-md-6"><strong>Receipt</strong>
                                        <p><?php echo $row_cust['Receipt_Name']; ?></p>
                                    </div>
                                </div>
                                  ...
                                  <hr>
                                   ...
                                   <div class="row text-center m-t-12">
                                    ...
                                    <div class="col-md-6"><strong>Institution</strong>
                                        <p><?php echo $row_cust['institution']; ?></p>
                                    </div>
                                </div>
                                </div>
                             </div>
 ...
 <?php echo $row_cust ['Rate_USD']; ?><?php echo $row_cust ['Rate_for_WS_USD']; ?> <br><h3>(THB&nbsp;<?php echo $row_cust ['admin_Cre']; ?>)</h3>
