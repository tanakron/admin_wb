...
$sql = "INSERT INTO `costomer_re_eng_success_th` (`titel`,`first_name_eg`,`last_name_eg`,`medicalLicense`,`Department`,`institution`,`Address`,`City`,`Province`,`Postal_Code`,`country`,`tel`,`Mobile`,`fax`,`email`,`Tpye_Reg`,`Rate_for_WS_USD`,`fileUpload`,`Payment_Credit`,`Rate_USD`,`Payment`,`custID`,`STATUS`,`food`,`Receipt_Name`,`Receipt_Address`,`eng_th`,`Remark`,`hospital`,`dateTime`) "
...
if ($result) {
    echo "
                        <script>
                            ...
                            window.location = 'Th_dashboard.php';
                        </script>
                    ";
} else {
