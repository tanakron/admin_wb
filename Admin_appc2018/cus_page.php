...
<body class="fix-sidebar">
    <!-- Page Content -->
                 ...
                 <div class="col-md-12">  
                      <div class="row">
                           <div class="col-md-6">  <label> First Name* </label>
                               <input type="text" class="md-input uk-form-width-medium"name="frmcontact_firstname" value=""/></div>
                          <div class="col-md-6"> <label> Family Name* </label>
                    <input type="text" class="md-input uk-form-width-medium"name="frmcontact_familyname"value="" /></div>
                         </div>  </div>  
                       <div class="col-md-12"> 
                           <div class="row">
                           <div class="col-md-6"> <label>Department*</label>
                    <input type="text" name=frmcontact_department class="md-input uk-form-width-medium"value="" /></div>
                     <div class="col-md-6"> <label>Institution*</label>
                    <input type="text" name=frmcontact_institute class="md-input uk-form-width-medium"value="" /></div>
                     </div></div>  
                  <div class="col-md-12"> 
                      <div class="row">
                            <div class="col-md-6"><label>Address*</label>
                    <input type="text" name=frmcontact_addr class="md-input uk-form-width-large"value="" /></div>
                       
                            <div class="col-md-6">  <label>City / District *</label>
                    <input type="text" name=frmcontact_amphur class="md-input uk-form-width-medium"value="" /></div>
                           </div>
                    </div>
                     <div class="col-md-12"> 
                         <div class="row">
                    <div class="col-md-6"><label> State / Province </label>
                    <input type="text" name=frmcontact_province class="md-input uk-form-width-medium"value="" /></div>
                         
                         <div class="col-md-6">  <label> Post Code </label>
                    <input type="text" name=frmcontact_zipcode class="md-input uk-form-width-medium"value="" /> </div>
                  </div>
                         </div>
            ...
            <div class="col-md-6">
                        <label> Tel. *</label>
                        <input type="text" name=frmoffice_tel value=""/>
                 </div>
                          <div class="col-md-6">   <label> Mobile*</label>
                                <input type="text" name=frmmobile value=""/>
                 </div>
                         </div>
                     
                  <div class="col-md-12">  
                      <div class="row">
                         <div class="col-md-6"> <label> Fax</label>
                                 <input type="text" name=frmfax value=""/>
                 </div>
                                
                                  <div class="col-md-4">  <label> E-mail (optional)</label>
                                    <input type="text" name=frmemail2 value="" />
                 </div>
    
                <div class="col-md-3">    <label> E-mail*</label>
                 ...
                 <div class="col-md-12">
                      ...
                      <div class="col-md-6"> 
                                       <label> Abstract Title * Authors*</label>
                                            
                              <input type="text" name="abstracttitle" required />
 </div> 
                                     <div class="col-md-6">     
                                   Type of Presentation*
 &nbsp;&nbsp;&nbsp;&nbsp;  <input type=checkbox name="typepresentation" value="Oral"> Oral 
 &nbsp;&nbsp;&nbsp;&nbsp;  <input type=checkbox name="typepresentation" value="Poster"> Poster 
  </div>  </div> 
           ...
           <hr> </div> 
            ...
            <div class="col-md-6"> </div>
                          ...
                          <div class="col-md-12">               
                                ...
                                <label for="radio_demo_inline_1" class="inline-label" >    <input type="radio" name="frmab_certify" value="yes_certify" /> I certify that this abstract has neither been published nor presented previously.</label>
                                  ...
                                  <?php
                        include 'db/database.php';
                        $sql_cust = "SELECT * FROM costomer_eng  WHERE custID={$_GET['custID']} ";
                        $result_cust = mysqli_query($link, $sql_cust);
                        $count_cust = mysqli_fetch_assoc($result_cust);
                        ?>
                             
                                        <input type="hidden" name="custID" value="<?php echo $count_cust['custID'];?>">
                            <center>
                                      
                                        <input class="btn btn-info  text-uppercase waves-effect waves-light" type="submit" value="Save"> </center>
