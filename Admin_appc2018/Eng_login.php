    ...
    <section id="wrapper" class="login-register">
        ...
        <div class="login-box login-sidebar">
            ...
            <div class="white-box">
                <form class="form-horizontal form-material" id="form1" action="Eng_login_go.php" method="post">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="ENG_register.php" class="text-primary m-l-5"><b>Sign Up</b></a></p>
                        </div>
                    </div>
                </form>
