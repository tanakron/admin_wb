...
<font size="5" color="white"> <right>Personal Detail</right></font></div>
<br><br><br>
<div class="col-md-6 col-xs-6">
     <b>Titel</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input type="text"name="titel"value="<?= $row_cust ['TiTel'];?>">  <br><br>
          ...
          <div class="col-md-6 col-xs-6">              
                               <b>MedicalLicense&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </b><input type="text"name="medicalLicense"value="<?= $row_cust ['medicalLicense'];?>"> <br><br>
...
<div class="col-md-6">
                        ...
                        &nbsp;&nbsp;&nbsp; <input type="radio" value="Master card" name="Payment">&nbsp;&nbsp;&nbsp;Master card<br>
                          <input type="radio" value="Payment by Bank Transfer" name="Payment_Credit">Bank Transfer<br>
 ...
 <div class="col-md-9">
   ...
   <b>Receipt Address &nbsp;&nbsp;&nbsp;</b><input type="text"name="Receipt_Address"value="">
           ...
           <input type="file" name="fileUpload" >(*.jpg, *.png, *.pdf)
