...
<body>
        <div class="container">
            ...
            <div class="form-group">
             ...
             <div class="col-md-9 col-xs-12 col-sm-6" ><br>
                 <img src="img/webhead-959.png">
                <br>Create Account
                 <form action="insertRegister.php" class="form-horizontal form-bordered" method="post" >
 อาชีพ 
                                                            <p class="text-back"> 
                                                            <input type="radio" name="TiTel" value="แพทย์" >  แพทย์
                                                            <input  type="radio"name="TiTel"value="พยาบาล">พยาบาล 
                                                                <input  type="radio"name="TiTel"value="นักศึกษา">นักศึกษา
                                                          <input type="text" placeholder="ชื่อ ภาษาไทย*  " class="form-control" name="first_name" value=""required> <p>
                                      <input type="text" placeholder="นามสกุล ภาษาไทย*  " class="form-control" name="last_name" value=""required> </p>
                                      <br> 
                     
                                     <input type="text" placeholder="First Name*  " class="form-control" name="first_name_eg" value=""required> <p>
                                      <input type="text" placeholder="Family name*  " class="form-control" name="last_name_eg" value=""required> </p>
                                      <br>

                                     
                                       
                                          <input type="text" placeholder="Medical License No." class="form-control" name="medicalLicense" value="">
                                          <br>
                                             <input type="text" placeholder="Department" class="form-control" name="Department" value="">
                                             <br>
                                              <input type="text" placeholder="institution" class="form-control" name="institution" value="">
                                       <br>
                                       
                                              <input type="text" placeholder="Address" class="form-control" name="Address" value="" required> 
                                             <br>
                                             <div class=""></div>
                   <input type="text" placeholder="Postal Code" class="form-control" name="Postal_Code" value="">
                                             <br>
                                             
                                             <div class="table-responsive">
                                             <table >
                                               <td valign=top> 
                                               <p class="text-white">Country<font class=require>*</font> </p> </td>
	<td valign=top >
	&nbsp;	<select name="country" >
        ...
        <option value="Thailand">Thailand</option><option value="Togo"  >Togo</option><option value="Tokelau"  >Tokelau</option><option value="Tonga"  >Tonga</option><option value="Trinidad and Tobago"  >Trinidad and Tobago</option><option value="Tunisia"  >Tunisia</option><option value="Turkey"  >Turkey</option><option value="Turkmenistan"  >Turkmenistan</option><option value="Turks and Caicos Islands"  >Turks and Caicos Islands</option><option value="Tuvalu"  >Tuvalu</option><option value="Uganda"  >Uganda</option><option value="Ukraine"  >Ukraine</option><option value="United Arab Emirates"  >United Arab Emirates</option><option value="United Kingdom"  >United Kingdom</option><option value="United States"  >United States</option><option value="United States Minor Outlying Islands     "  >United States Minor Outlying Islands     </option><option value="Uruguay"  >Uruguay</option><option value="Uzbekistan"  >Uzbekistan</option><option value="Vanuatu"  >Vanuatu</option><option value="Vatican City State (Holy See)"  >Vatican City State (Holy See)</option><option value="Venezuela"  >Venezuela</option><option value="Viet Nam"  >Viet Nam</option><option value="Virgin Islands (British)"  >Virgin Islands (British)</option><option value="Virgin Islands (US)"  >Virgin Islands (US)</option><option value="Wallis and Futuna Islands"  >Wallis and Futuna Islands</option><option value="Western Sahara"  >Western Sahara</option><option value="Yemen"  >Yemen</option><option value="Yugoslavia"  >Yugoslavia</option><option value="Zaire"  >Zaire</option><option value="Zambia"  >Zambia</option><option value="Zimbabwe"  >Zimbabwe</option>		</select>
                     ...
                     <br>
                                 <input type="text" placeholder="Tel.*" class="form-control" name="tel" value="">
                                      <br>
                                 
                                      <input type="text" placeholder="Fax" class="form-control" name="fax" value="">
                                   <hr class="b">
                                   <br>
                                 <input type="text" placeholder="Email*" class="form-control" name="email" value="" required>
                                      <br>
                                       <input type="text" placeholder="Password*" class="form-control" name="custPassword" value=""required>
                                      <br>
                                     ...
                                     <button type="submit" class="btn btn-success" value="">Submit</button>
                                      ...
                                      <br>
                                       <br>
                                   <a href="Eng_login.php"> <button type="submit" class="btn btn-danger" value="">Back</button></a>  
    ...
    $(document).ready(function () {
        ...
        $('#btn1').on("click", function (e) {
            if ($('#form1').smkValidate()) {
                $.post("insert_re2.php", $("#form1").serialize())
                        .done(function (data) {
