...
?></font>
   ...
   <input type="text" name="orderRef" value="<?php echo   Random(8);?>" class="form-control"placeholder="*Payment Number"required> </div>
                        ...
                        ?><?php echo $count_pay ['amount'];?>
                                
                              
                                <div class="form-group">
                                    <label class="col-md-12" for="toamt">Total Amount 
                               <input type="text" id="pname" name="amount" class="form-control"placeholder="Amount" value="<?php echo $count_pay ['amount'];?>"> 
                                    </label>
                                      <div class="col-md-12">
...
<input type="hidden" name="amount" value="<?php echo $count_pay ['amount'];?>" >
