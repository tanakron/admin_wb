...
<body>
             ...
             <div class="col-md-9 col-xs-12 col-sm-6" ><br>
                ...
                <br>Create Account
                 <form action="insertRegister.php" class="form-horizontal form-bordered" method="post" >
                                                            ...
                                                            <p class="text-back"> 
                                                            <input type="radio" name="TiTel" value="Mr" >  Mr.
                                                            <input  type="radio"name="TiTel"value="Mrs">Mrs.
                                                                <input  type="radio"name="TiTel"value="Miss">Miss.
                                                              <input type="radio" name="TiTel"value="Dr">Dr.
                                                             <input type="radio" name="TiTel"value="Prof">Prof.
                                                                     <p class="text-back"> &nbsp; &nbsp;other     <input type="text"  name="titel"value=""></p> 
        ...
        <br>
                   ...
                   <input type="text" placeholder="Postal Code" class="form-control" name="Postal_Code" value="">
                                             ...
                                             <table >
                                               <td valign=top> 
                                               <p >Country<font class=require>*</font> </p> </td>
	<td valign=top >
	&nbsp;	<select name="country" >
...
<table>
                     <tr><td> <button type="submit" class="btn btn-success" value="">Submit</button></td>
                                      ...
                                      <br>
                                       <br>
                                   <a href="http://www.appc2018.com"> <button type="submit" class="btn btn-danger" value="">Back</button></a>  
